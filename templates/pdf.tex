...
\newcommand{\USTextbook}{  paperwidth=7in,   paperheight=10in, left=0.875in,right=0.825in,top=0.825in,bottom=0.825in,twoside}
...
\newcommand{\Novella}{     paperwidth=5in,   paperheight=8in,  left=0.775in,right=0.525in,top=0.825in,bottom=0.825in,twoside}
